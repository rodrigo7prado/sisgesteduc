...
public class DBService {
	...
	public void instanciateTestDatabase() {
		...
		FiltroItem fi8 = new FiltroItem(null, fg8, "Pend. dados pessoais");
		FiltroItem fi9 = new FiltroItem(null, fg8, "Pend. [Matrícula]");
		FiltroItem fi10 = new FiltroItem(null, fg8, "Pend. [Nome completo]");
		FiltroItem fi11 = new FiltroItem(null, fg8, "Pend. [Data de Nascimento]");
		FiltroItem fi12 = new FiltroItem(null, fg8, "Pend. [Nacionalidade]");
		FiltroItem fi13 = new FiltroItem(null, fg8, "Pend. [Naturalidade]");
		FiltroItem fi14 = new FiltroItem(null, fg8, "Pend. [Naturalidade UF]");
		FiltroItem fi15 = new FiltroItem(null, fg8, "Pend. [Rg]");
		FiltroItem fi16 = new FiltroItem(null, fg8, "Pend. [Rg emissor]");
		FiltroItem fi17 = new FiltroItem(null, fg8, "Pend. [Rg emissor UF]");
		FiltroItem fi18 = new FiltroItem(null, fg8, "Pend. [Rg]");
		FiltroItem fi19 = new FiltroItem(null, fg8, "Pend. [Pai]");
		FiltroItem fi20 = new FiltroItem(null, fg8, "Pend. [Mãe]");

		FiltroItem fi21 = new FiltroItem(null, fg9, "Pend. de dados escolares");
		...
		FiltroItem fi24 = new FiltroItem(null, fg12, "Dif. c/ Conexão Educação");

		filtroItemRepository.saveAll(Arrays.asList(fi1, fi2, fi3, fi4, fi5, fi6, fi7, fi8, fi9, fi10, fi11, fi12, fi13,
				fi14, fi15, fi16, fi17, fi18, fi19, fi20, fi21, fi22, fi23, fi24));
	}
}
