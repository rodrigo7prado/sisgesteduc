...
@Controller
public class RelCertificacoesPorAlunoController5 implements Initializable {
...
//	private VBox vBoxControllerDadosAlunos;
	...
	private Class<RelCertificacoesPorAlunoController5> myClass;
...
//		filteredList = new FilteredList<>(observableList, p -> true);
	...
	private void setupPredicates() {
		...
		RelCertificacoesPorAlunoController5.class.getDeclaredFields();
		
		
		Class<RelCertificacoesPorAlunoController5> classe = RelCertificacoesPorAlunoController5.class;
