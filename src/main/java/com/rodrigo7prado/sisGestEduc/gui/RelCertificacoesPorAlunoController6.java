...
@Controller
public class RelCertificacoesPorAlunoController6 implements Initializable {
...
//	private VBox vBoxControllerDadosAlunos;
	...
	private Class<RelCertificacoesPorAlunoController6> myClass;
...
//		filteredList = new FilteredList<>(observableList, p -> true);
	...
	private void setupPredicates() {
		...
		RelCertificacoesPorAlunoController6.class.getDeclaredFields();
		
		
		Class<RelCertificacoesPorAlunoController6> classe = RelCertificacoesPorAlunoController6.class;
