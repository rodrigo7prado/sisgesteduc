...
@Controller
public class RelCertificacoesPorAlunoController4 implements Initializable {
...
//	private VBox vBoxControllerDadosAlunos;
	...
	private Class<RelCertificacoesPorAlunoController4> myClass;
...
//		filteredList = new FilteredList<>(observableList, p -> true);
	...
	private void setupPredicates() {
		...
		RelCertificacoesPorAlunoController4.class.getDeclaredFields();
		
		
		Class<RelCertificacoesPorAlunoController4> classe = RelCertificacoesPorAlunoController4.class;
