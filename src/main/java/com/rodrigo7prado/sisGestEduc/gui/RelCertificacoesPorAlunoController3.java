...
@Controller
public class RelCertificacoesPorAlunoController3 implements Initializable {
...
//	private VBox vBoxControllerDadosAlunos;
	...
	private Class<RelCertificacoesPorAlunoController3> myClass;
...
//		filteredList = new FilteredList<>(observableList, p -> true);
	...
	private void setupPredicates() {
		...
		RelCertificacoesPorAlunoController3.class.getDeclaredFields();
		
		
		Class<RelCertificacoesPorAlunoController3> classe = RelCertificacoesPorAlunoController3.class;
