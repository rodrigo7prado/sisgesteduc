...
public class AlunoPeriodoCurricularDto2 {
	...
	AlunoPeriodoCurricularDto2() {
	}
	
	public AlunoPeriodoCurricularDto2(ResultadoFinalExternal obj) {
		id = obj.getId();
...
//		matricula = obj.getMatricula();
	...
	public AlunoPeriodoCurricularDto2(String anoLetivo, String modalidade, String curso, String serie, String turno,
