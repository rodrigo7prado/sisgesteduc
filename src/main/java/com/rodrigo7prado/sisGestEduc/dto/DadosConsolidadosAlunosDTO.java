...
public class DadosConsolidadosAlunosDTO {
	...
	DadosConsolidadosAlunosDTO() {
	}
	
	public DadosConsolidadosAlunosDTO(DadosConsolidados obj) {
		id = obj.getId();
	...
	public DadosConsolidadosAlunosDTO(String anoLetivo, String modalidade, String curso, String serie, String turno,
			String turma, String aluno, String nomeCompl, String freq, String situacaoFinal) {
		super();
