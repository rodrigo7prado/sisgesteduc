...
@Entity
@Table(name = "certidoes_external")
public class CertidoesCsv  implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@Id
	@Column(name = "nfl", length = 25)
	private Integer nfl; 
	...
	public Integer getNfl() {
		return nfl;
	}

	public void setNfl(Integer nfl) {
		this.nfl = nfl;
	}
	...
	public Date getCnEmissao() {
		return cnEmissao;
	}

	public void setCnEmissao(Date cnEmissao) {
		this.cnEmissao = cnEmissao;
	}
